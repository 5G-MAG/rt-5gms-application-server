...
from rt_5gms_as.openapi_5g import rest
from rt_5gms_as.openapi_5g.configuration import Configuration
from rt_5gms_as.openapi_5g.exceptions import ApiTypeError, ApiValueError, ApiException
from rt_5gms_as.openapi_5g.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_content_hosting_configuration  # this is an instance of the class Endpoint
        api_instance.create_content_hosting_configuration()  # this invokes api_instance.create_content_hosting_configuration.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_content_hosting_configuration.callable or self.callable in this class
